...
<ul>
  ...
  <li>Mac users: If you want to keep your laptop awake until it registers you (or you terminate the process), use: <code>caffeinate -is python ubcCourseChecker.py</code></li>
</ul> 
